...
void hapus_paket1(node1 **head, node2 **phead)
{
	...
	{
		cout << "Pilih Tindakan (1. Proses ke BnK / 2. Batal Pengiriman / 3. Edit Data Pengirim / 4. Edit Data Penerima): ";
		int action;
		cin >> action;
		...
		{
			deleteNode(head, pPre, pCur);
			cout << "Paket dengan No Resi " << pos << " Berhasil Dibatalkan !!!" << endl;
		}
		else if (action == 3)
		{
			cout << "Edit Data Pengirim untuk No Resi " << pos << endl;
			cout << "Masukkan Nama Pengirim Baru: ";
			cin >> pCur->nama_pengirim1;
			cout << "Masukkan Alamat Pengirim Baru: ";
			cin >> pCur->asal1;
			cout << "Masukkan Nomor Telepon Pengirim Baru: ";
			cin >> pCur->telp_pengirim1;
		}
		else if (action == 4)
		{
			cout << "Edit Data Penerima untuk No Resi " << pos << endl;
			cout << "Masukkan Nama Penerima Baru: ";
			cin >> pCur->nama_penerima1;
			cout << "Masukkan Alamat Penerima Baru: ";
			cin >> pCur->tujuan1;
			cout << "Masukkan Nomor Telepon Penerima Baru: ";
			cin >> pCur->telp_penerima1;
		}
		else
		{
